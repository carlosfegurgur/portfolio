    ...
    <section id={styles["hero"]}>
      <div className={styles["container"]}>
        <div className={styles["bio"]}>
          <span className={styles["topper"]}>Hafa Adai</span>
          <h1 className={styles["title"]}>
            I am <span className={styles["accent"]}>Carlos</span>!
          </h1>
          <p>
            A front-end developer specializing in modern web applications. From
            interactive UI/UX to efficient performance, I build solutions that are
            both functional and visually compelling. I offer feedback and support
            from start to finish, taking your ideas from concept to code to
            complete.
          </p>
        </div>
        <div className={styles["btn-container"]}>
          <Button isLink text="See My Work" href="/projects" />
          <Button isLink secondary text="Get In Touch" href="/contact" />
        </div>
      </div>
      {/* <!--Hero Image--> */}
